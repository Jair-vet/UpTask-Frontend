        ...
        <Dialog as="div" className="relative z-10" onClose={() => navigate(location.pathname, {replace: true}) }>
            ...
            <div className="fixed inset-0 overflow-y-auto">
                <div className="flex min-h-full items-center justify-center p-4 text-center ">
                    ...
                    >
                        <Dialog.Panel className="w-full md:m-10 m-7 max-w-3xl transform overflow-hidden rounded-2xl bg-slate-500 text-left align-middle shadow-xl transition-all p-16">
                            <Dialog.Title
                                as="h3"
                            ...
                            <p className="text-xl font-bold text-white">Make changes to a task in {''}
                                <span className="text-green-500">This Form</span>
                            </p>
